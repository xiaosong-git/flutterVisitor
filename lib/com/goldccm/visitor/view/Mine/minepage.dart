...
import 'package:visitor/com/goldccm/visitor/view/Mine/HeaderPage.dart';
import 'package:visitor/com/goldccm/visitor/view/Mine/companypage.dart';
import 'package:visitor/com/goldccm/visitor/view/Mine/identifypage.dart';
import 'package:visitor/com/goldccm/visitor/view/Mine/settingpage.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:visitor/com/goldccm/visitor/view/Mine/visitRecord.dart';
      ...
      onTap: () async {
        if (method == "_meetingRoom") {
          ...
          if (userInfo.isAuth == "T") {
            ToastUtil.showShortClearToast("您已完成实人认证");
          } else {
            Navigator.push(
                context,
                CupertinoPageRoute(
