  ...
  Widget switchType(UserInfo user) {
    ...
    if (_visitInfo.recordType == "1") {
      return Scaffold(
            ...
            child: Column(
              children: <Widget>[
                Container(
                    ...
                    child: _visitInfo.userId == user.id.toString()
                        ? _visitInfo.cstatus == "applyConfirm"
                            ? RichText(
                                text: TextSpan(
                                    text: '您',
                ...
                _visitInfo.userId == user.id.toString()
                    ? Container(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            _visitInfo.companyName != null
                                ? _visitInfo.companyName
                                : "暂无访问地址",
                            style: TextStyle(
                                color: Colors.black54,
                                fontSize: 16.0,
                            ...
                            if (_visitInfo.cstatus == "applyConfirm") {
                              Navigator.push(
                                ...
                                if (value != null) {
                                  ...
                                  setState(() {
                                    _visitInfo.companyName =
                                        _mineAddress[value].companyName;
                                  });
                                }
                              });
                            }
        ...
        bottomSheet: _visitInfo.userId == user.id.toString()
            ? _visitInfo.cstatus == "applyConfirm"
                ? DateTime.parse(_visitInfo.endDate).isBefore(DateTime.now())
                    ? Container(
                        height: 50,
                        child: Text(
                          "已过期",
      ...
      return Scaffold(
        ...
        body: WillPopScope(
            child: Column(
              children: <Widget>[
                Container(
                    padding: EdgeInsets.all(30),
                    child: _visitInfo.visitorId == user.id.toString()
                        ? _visitInfo.cstatus == "applyConfirm"
                            ? RichText(
                                text: TextSpan(
                                    text: '您',
                ...
                Container(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(
                      _visitInfo.startDate != null ? _visitInfo.startDate : "",
                      style: TextStyle(
                          color: Colors.black54,
                          fontSize: 16.0,
                          letterSpacing: 1),
                ...
                Container(
                  ...
                  child: ListTile(
                    title: Text('洽谈结束时间',
                        ...
                        textScaleFactor: 1.0),
                    subtitle: Text(
                        _visitInfo.endDate != null ? _visitInfo.endDate : "",
                        style: TextStyle(
                            color: Colors.black54,
                            fontSize: 16.0,
                            letterSpacing: 1),
        ...
        bottomSheet: _visitInfo.visitorId == user.id.toString()
            ? _visitInfo.cstatus == "applyConfirm"
                ? DateTime.parse(_visitInfo.endDate).isBefore(DateTime.now())
                    ? Container(
                        height: 50,
