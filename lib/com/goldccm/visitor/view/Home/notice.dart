    ...
    return Scaffold(
      appBar: PreferredSize(
        ...
        child: AppBar(
          ...
          flexibleSpace: Image(
            image: AssetImage('assets/images/home_notice_background.png'),
            fit: BoxFit.cover,
          ),
...
class NoticeDetail extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('公告详情',textScaleFactor: 1.0,style: TextStyle(fontSize: ScreenUtil().setSp(36),color: Color(0xFF373737)),),
        centerTitle: true,
        backgroundColor: Color(0xFFFFFFFF),
        elevation: 1,
      ...
      body: SingleChildScrollView(
        child:Container(
          ...
          child:Column(
            ...
            children: <Widget>[
              Container(
                child:  Text(noticeTitle,textScaleFactor: 1.0,style: TextStyle(fontSize: 20.0),),
                padding: EdgeInsets.only(bottom: 10.0),
              ),
              Text('$createDate $createTime',textScaleFactor: 1.0,style: TextStyle(color: Color(0xFF6C6C6C),fontSize: 13),),
              Divider(),
